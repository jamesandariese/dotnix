# loaded from home.nix

# NOTE: this file has \\xXX in strings.  these are double escaped.
#       THIS IS ESSENTIAL.  nix doesn't support \x escapes so we
#       _must_ pass them through to alacritty to interpret.
#       also, nix?  what on earth are you thinking with your escapes?
#       note note: I suspect we can get around this problem by 
#                  somehow coercing 0xa to a char (or 1c string) and
...
{ window = {
  ...
  key_bindings = [
    ...
    { key = "Back"; mods = "Alt|Shift"; chars = "\\x1b\b"; }
